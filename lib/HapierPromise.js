...
(function (root, factory) {
	...
	if (typeof exports === 'object') {
		if (typeof module === 'object' && module.exports) {
			...
			exports.HapierPromise = factory();
		}
	} else if (typeof define === 'function' && define.amd) {
		define([], factory);
	} else if (typeof YUI === 'function') {
		YUI.add('HapierPromise', function (Y) {
			Y.HapierPromise = factory();
		});
	} else if (typeof root === 'object') {
		root.HapierPromise = factory();
	} else {
		throw "Unable to export HapierPromise";
	}
}(this, function () {
	'use strict';
