...
(function (root, factory) {
	...
	if (typeof exports === 'object') {
		...
		YUI.add('Uri', function (Y) {
			Y.Uri = factory();
		});
	} else if (typeof root === 'object') {
		root.Uri = factory();
	} else {
		throw "Unable to export Uri";
	}
}(this, function () {
	'use strict';
	 ...
	 * @param string|Uri base Used to resolve 'uri' (optional)
	 */
	...
	Uri.prototype.toString = function toString() {
		...
		if (this.fragment || this.forceFragment) {
			str += '#' + this.fragment;
		}
